...
class VxSkeletonState extends State<VxSkeleton>
  ...
  Tween<double> _genTween() {
    return (widget.type == VxSkeletonAnimationType.shimmer)
        ? Tween(begin: -1, end: 2)
        : Tween(begin: widget.width, end: widget.stretchWidth);
  }
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final color = widget.color ?? const Color(0xFFE8E8E8);
        final shimmerColor = widget.shimmerColor ?? const Color(0xFFEDEDED);
        ...
        final width = widget.type == VxSkeletonAnimationType.shimmer
            ? widget.width
            : _animation.value;
        final decColor =

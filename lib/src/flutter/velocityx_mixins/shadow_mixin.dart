...
mixin VxShadowMixin<T> {
  ...
  /// Shadowing
  T get outerShadowSm => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 1),
            blurRadius: 2,
  ...
  T get outerShadowMd => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 4),
            blurRadius: 6,
  ...
  T get outerShadowLg => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 10),
            blurRadius: 15,
  ...
  T get outerShadowXl => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 20),
            blurRadius: 25,
  ...
  T get outerShadow2Xl => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 25),
            blurRadius: 50,
  ...
  T get outerShadow3Xl => _addShadow(
        shadows: [
          const BoxShadow(
            offset: Offset(0, 35),
            blurRadius: 60,

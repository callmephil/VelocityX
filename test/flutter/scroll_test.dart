...
void main() {
  group('Group all Scroll tests', () {
    ...
    //   final box = tester.renderObject(find.byType(Container));
    ...
    //   await tester.drag(
    //       find.byType(SingleChildScrollView), const Offset(-200, -300),);
    //   // once the scroll up is performed, the starting point of Container
    //   // will Offset(0,-300)
    //   expect(box.localToGlobal(Offset.zero), equals(const Offset(0, -300)));
    // });
    ...
    //   // will Offset(-300,0)
    //   expect(box.localToGlobal(Offset.zero), equals(const Offset(-300, 0)));
    // });
  });
}
